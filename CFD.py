...
class NavierStokes (plot2d):
    ...
    def computeAuxiallyVelocity(self):
        ...
        u_aux_1120 = u_11 * (u_11_20 - u_11_21) / (2 * dx)
        u_aux_1121 = v_11 * (u_20_11 - u_21_11) / (2 * dy)
        u_aux_2011 = (u_11_20 - 2.0 * u_11 + u_11_21) / dx**2
        u_aux_2111 = (u_20_11 - 2.0 * u_11 + u_21_11) / dy**2

        v_aux_1120 = u_11 * (v_11_20 - v_11_21)
        v_aux_1121 = v_11 * (v_20_11 - v_21_11)
        v_aux_2011 = v_11_20 - 2.0 * v_11 + v_11_21
        v_aux_2111 = v_20_11 - 2.0 * v_11 + v_21_11

        u_aux[1:-1, 1:-1] += -dt * (u_aux_1120 + u_aux_1121)
        u_aux[1:-1, 1:-1] += +dt * ν * (u_aux_2011 + u_aux_2111)

        v_aux[1:-1, 1:-1] += -dt * (v_aux_1120 + v_aux_1121)
        v_aux[1:-1, 1:-1] += +dt * ν * (v_aux_2011 + v_aux_2111)
